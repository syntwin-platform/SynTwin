                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                    ...
                    {session ? (
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link
                                href="/register"
                                className="inline-flex min-h-11 items-center rounded-md bg-brand px-4 text-sm font-semibold text-white"
                            >
                                Tạo tài khoản
                            </Link>
                        </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="my-6 border-y border-[#E2E8F0] py-4">
                                            ...
                                            <div className="mt-2">
                                                <span className="inline-block rounded-md border border-[#E2E8F0] bg-[#F8FAFC] px-2.5 py-1 text-xs font-semibold text-[#C52F00]">
                                                    {pkg.robotsFormatted}
                                                </span>
                                            </div>
                                        </div>
